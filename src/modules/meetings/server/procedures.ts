...
export const meetingsRouter = createTRPCRouter({
    ...
    getTranscript: protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
            ...
            const transcription = await fetch(existingMeeting.transcriptUrl)
                .then((res) => res.text())
            ...
            const speakerIds = [
                ...new Set(transcription.map((item) => item.speaker_id))
            ]
            ...
            const transcriptionWithSpeakers = transcription.map((item) => {
